...
def get_args_parser():
    parser = argparse.ArgumentParser('Open BHB', add_help=False)
    ...
    parser.add_argument('--root-path', default='/path/to/open_bhb', type=str)
    parser.add_argument('--save-path', default='/path/to/pub_brain_5/open_bhb/', type=str)
    return parser
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Open BHB', parents=[get_args_parser()])
