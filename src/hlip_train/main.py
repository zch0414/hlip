...
from hlip_train.data import get_data
...
def main(args):
    ...
    if 'train' in data and optimizer is not None:
        total_steps = (data["train"].dataloader.num_batches // (args.accum_freq * args.accum_batch)) * args.epochs
        if args.lr_scheduler == "cosine":
            ...
            cooldown_steps = (data["train"].dataloader.num_batches // (args.accum_freq * args.accum_batch)) * args.epochs_cooldown
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if any(v in data for v in ('valid', 'mri', 'ct')):
