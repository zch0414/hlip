...
from hlip.zeroshot_metadata_mri import CLASSNAMES, TEMPLATES, PROMPTS
...
def get_args_parser():
    ...
    parser.add_argument('--data-root', default='/path/to/mri')
    parser.add_argument('--input-file', default='../../data/mri.csv')
