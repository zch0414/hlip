...
def main():
    ...
    parser.add_argument("--repo-id", type=str,
                        default="Zch0414/hlip-2025-10-08",
    ...
    parser.add_argument("--ckpt", type=str, required=False,
                        default="/nfs/turbo/umms-tocho-snr/exp/chuizhao/hlip/DATE_2025_10_08-13_22_14-MODEL_ablate_seqposemb_clip_vit_base_multiscan_h2_dinotxt1568/checkpoints/epoch_5.pt",
